...
def force_from_gravity(mass_one, mass_two, distance):
    ...
    return (GRAVITATION * mass_one * mass_two) / (distance**2)
...
def time_until_destination(time_step, ship_mass, engine_force, target_distance):
    """ return number of seconds until reaching target distance at constant force due to unchanging force """
...
def get_transit_time(target_solar_orbit_radius):
    ...
    return transit_time
    transit_time = time_until_halfway * 2  
